...
const P_top = () => {
  ...
  <div className="overflow-hidden">
    ...
    <div className="shapes relative w-full h-screen bg-blue-300 overflow-hidden">
      ...
      <h2 className="absolute top-0 left-0 text-6xl lg:text-8xl font-bold text-zinc-900 tracking-wide w-full h-screen overflow-hidden flex justify-center items-center bg-white mix-blend-screen">テクそら = Tech + Clear (空)<br/>~Web技術を明瞭に~</h2>
      <div>Scroll</div>
    </div>
